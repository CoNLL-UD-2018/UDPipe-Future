...
while read code; do
  ...
  for reg in --label_smoothing=0; do # --word_dropout=0 --dropout=0 "--dropout=0 --word_dropout=0 --label_smoothing=0"; do
    qsub -q gpu*@dll* -cwd -b y -l gpu=1,gpu_cc_min3.5=1 -j y withcuda venv/bin/python3 ud_parser4b.py ud-2.2-conll18/$code/$code $args $reg
  done
#  best=0
#  args=""
#  args_other=""
