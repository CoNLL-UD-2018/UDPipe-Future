    ...
    def train_epoch(self, train, learning_rate, args):
        ...
        while batches < 300:
            while not train.epoch_finished():
                ...
                if args.embeddings:
                    if args.embeddings_sentence_dropout:
                        mask = np.random.binomial(n=1, p=args.embeddings_sentence_dropout, size=(word_ids[train.EMBEDDINGS].shape[0], 1))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--embeddings_sentence_dropout", default=None, type=float, help="External embeddings sentence dropout.")
